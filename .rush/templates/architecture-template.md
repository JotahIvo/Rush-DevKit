<!-- Budget: 100 lines per feature section. Density over completeness. -->
<!-- ARCHITECTURE artifact: structural HOW and trade-offs. Never a step-by-step implementation
     recipe (that's plan.md) and never a redefinition of behaviour (that's spec.md). -->
<!-- Filled by /rush-architect. One section per feature, appended to .rush/memory/architecture.md -->
